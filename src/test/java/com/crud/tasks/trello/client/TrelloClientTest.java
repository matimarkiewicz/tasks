...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloUsername()).thenReturn("mateuszmarkiewicz5");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI url = new URI("http://test.com/members/mateuszmarkiewicz5/" +
    ...
    public void shouldCreateCard() throws URISyntaxException {
        ...
        URI url = new URI("http://test.com/cards?key=test&token=test&" +
                "name=Test%20task&desc=Test%20Description&pos=top&idList=test_id");
