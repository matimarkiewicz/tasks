...
public class TrelloMapperTest {
    ...
    public void mapToBoardsTest() {
        //Given
        TrelloListDto trelloListDto = new TrelloListDto("2.8", "testList", false);
        List<TrelloListDto> listDto = Arrays.asList(trelloListDto);

        TrelloBoardDto trelloBoardDto = new TrelloBoardDto("testBoard", "4", listDto);
    ...
    public void mapToBoardsDtoTest() {
        //Given
        TrelloList trelloList = new TrelloList("2", "newList", false);
        List<TrelloList> list = Arrays.asList(trelloList);

        TrelloBoard trelloBoard = new TrelloBoard("newBoard", "1", list);
    ...
    public void mapToCardTest() {
        //Given
        TrelloCardDto trelloCardDto = new TrelloCardDto("card", "description", "position", "2.8");
    ...
    public void mapToCardDtoTest() {
        //Given
        TrelloCard trelloCard = new TrelloCard("card", "description", "position", "2.8");
